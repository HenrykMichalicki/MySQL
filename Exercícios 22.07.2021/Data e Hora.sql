...
CREATE TABLE tb_funcionarios (
	...
	data_nasc DATE NOT NULL, -- Atributo do tipo Data, precisa ser digitada a data "yyyy-mm-dd"
    hora_nasc TIME, -- Atributo do tipo Hora, precisa digitar a info
	email varchar(255) NOT NULL,
	data_criacao TIMESTAMP NOT NULL, -- Atributo do tipo Data e hora baseado fuso horário atual, precisa INFORMAR ao sistema para que ele busque tal info
	data_atualizacao TIMESTAMP NOT NULL,
	PRIMARY KEY (`id`)
);

/*
CURRENT_TIMESTAMP(): O atributo receberá a data e a hora do servidor no momento da gravação dos dados --> CURRENT_TIMESTAMP()
...
*/
select nome as Nome, 
DATE_FORMAT(curdate(), "%d/%m/%Y") as Hoje, -- traz só a data
DATE_FORMAT(data_nasc, "%d/%m/%Y") as Data_de_Nascimento,
